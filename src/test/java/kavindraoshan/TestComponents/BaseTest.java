...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		// Getting Global Properties File Location
		FileInputStream fs = new FileInputStream(
				System.getProperty("user.dir") + "\\src\\main\\java\\kavindraoshan\\Resources\\GlobalData.properties");

		// Load the Global Properties
		prop.load(fs);

		// Querying the browser name with Ternary Operator
	...
	public LandingPage launchApplication() throws IOException {
		...
		// Getting the webdriver from the initialization class
